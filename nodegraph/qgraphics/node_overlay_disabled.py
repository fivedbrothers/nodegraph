...
from nodegraph.constants import Z_VAL_NODE_WIDGET
...
class XDisabledItem(QtWidgets.QGraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        if self.text and not self.proxy_mode:
            ...
            font_width = font_metrics.boundingRect(self.text).width()
            font_height = font_metrics.boundingRect(self.text).height()
