...
from nodegraph.qgraphics.node_overlay_disabled import XDisabledItem
from nodegraph.qgraphics.node_text_item import NodeTextItem
from nodegraph.qgraphics.port import PortItem, CustomPortItem
...
class NodeItem(AbstractNodeItem):
    ...
    def post_init(self, viewer=None, pos=None):
        ...
        Args:
            viewer (nodegraph.widgets.viewer.NodeViewer): not used
