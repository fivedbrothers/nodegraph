...
class NodeBaseWidget(QtWidgets.QGraphicsProxyWidget):
    ...
    added in a :class:`nodegraph.BaseNode` object.

    Args:
        parent (nodegraph.BaseNode.view): parent node view.
    ...
    def node(self):
        ...
        Returns:
            nodegraph.BaseNode: parent node.
        """
        return self._node
...
class NodeComboBox(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraph.BaseNode.add_combo_menu`
    """
...
class NodeLineEdit(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraph.BaseNode.add_text_input`
    """
...
class NodeCheckBox(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraph.BaseNode.add_checkbox`
    """
