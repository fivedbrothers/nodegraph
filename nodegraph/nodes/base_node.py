...
class BaseNode(NodeObject):
    """
    The ``nodegraph.BaseNode`` class is the base class for nodes that allows
    port connections from one node to another.

    **Inherited from:** :class:`nodegraph.NodeObject`
    ...
    def add_custom_widget(self, widget, widget_type=NODE_PROP_QLABEL, tab=None):
        ...
        Args:
            ...
            widget_type: widget flag to display in the
                :class:`nodegraph.PropertiesBinWidget` (default: QLabel).
    ...
    def add_input(self, name='input', multi_input=False, display_name=True,
        ...
        Returns:
            nodegraph.Port: the created port object.
        """
    ...
    def input_ports(self):
        ...
        Returns:
            list[nodegraph.Port]: node input ports.
        """
        return self._inputs
    ...
    def output_ports(self):
        ...
        Returns:
            list[nodegraph.Port]: node output ports.
        """
    ...
    def set_input(self, index, port):
        ...
        Args:
            ...
            port (nodegraph.Port): port object.
        """
    ...
    def on_input_connected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (nodegraph.Port): source input port from this node.
            out_port (nodegraph.Port): output port that connected to this node.
        """
        return
