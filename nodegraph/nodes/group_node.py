...
from nodegraph.constants import (NODE_LAYOUT_VERTICAL,
                                   NODE_LAYOUT_HORIZONTAL)

from nodegraph.nodes.base_node import BaseNode
from nodegraph.nodes.port_node import PortInputNode, PortOutputNode
from nodegraph.qgraphics.node_group import (GroupNodeItem,
                                              GroupNodeVerticalItem)


class GroupNode(BaseNode):
    """
    The ``nodegraph.GroupNode`` class extends from the
    :class:``nodegraph.BaseNode`` class with the ability to nest other nodes
    inside of it.

    **Inherited from:** :class:`nodegraph.BaseNode`
    ...
    def get_sub_graph(self):
        ...
        Returns:
            nodegraph.SubGraph or None: sub graph controller.
        """
