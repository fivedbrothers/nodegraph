...
from nodegraph.constants import (NODE_PROP_QTEXTEDIT,
...
class BackdropNode(NodeObject):
    """
    The ``nodegraph.BackdropNode`` class allows other node object to be
    ...
    **Inherited from:** :class:`nodegraph.NodeObject`
    ...
    def wrap_nodes(self, nodes):
        ...
        Args:
            nodes (list[nodegraph.NodeObject]): list of nodes.
        """
        if not nodes:
            return
    ...
    def nodes(self):
        ...
        Returns:
            list[nodegraph.BaseNode]: list of node under the backdrop.
        """
