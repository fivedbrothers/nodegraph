...
from nodegraph.errors import PortRegistrationError
from nodegraph.nodes.base_node import BaseNode
from nodegraph.qgraphics.node_port_in import (PortInputNodeItem,
                                                PortInputNodeVerticalItem)
from nodegraph.qgraphics.node_port_out import (PortOutputNodeItem,
...
class PortInputNode(BaseNode):
    ...
    :class:`nodegraph.GroupNode` when expanded in a
    :class:`nodegraph.SubGraph`.
