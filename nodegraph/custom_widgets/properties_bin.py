...
from nodegraph.custom_widgets.properties import NodePropWidget
...
class PropertiesBinWidget(QtWidgets.QWidget):
    """
    The :class:`nodegraph.PropertiesBinWidget` is a list widget for displaying
    ...
    .. code-block:: python
        ...
        from nodegraph import NodeGraph, PropertiesBinWidget
    ...
    Args:
        ...
        node_graph (nodegraph.NodeGraph): node graph.
    """
    ...
    def remove_node(self, node):
        ...
        Args:
            node (str or nodegraph.BaseNode): node id or node object.
        """
    ...
    def prop_widget(self, node):
        ...
        Args:
            node (str or nodegraph.NodeObject): node id or node object.
