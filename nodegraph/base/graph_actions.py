...
def _curved_pipe(graph):
    ...
    """
    from nodegraph.constants import PIPE_LAYOUT_CURVED
...
def _straight_pipe(graph):
    ...
    """
    from nodegraph.constants import PIPE_LAYOUT_STRAIGHT
...
def _bg_grid_none(graph):
    ...
    """
    from nodegraph.constants import VIEWER_GRID_NONE
...
def _bg_grid_dots(graph):
    ...
    """
    from nodegraph.constants import VIEWER_GRID_DOTS
...
def _bg_grid_lines(graph):
    ...
    """
    from nodegraph.constants import VIEWER_GRID_LINES
