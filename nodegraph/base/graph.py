...
from nodegraph.base.commands import (NodeAddedCmd,
                                       ...
                                       NodeMovedCmd,
                                       PortConnectedCmd)
from nodegraph.base.factory import NodeFactory
from nodegraph.base.menu import NodeGraphMenu, NodesMenu
from nodegraph.base.model import NodeGraphModel
...
from nodegraph.nodes.backdrop_node import BackdropNode
from nodegraph.nodes.base_node import BaseNode
from nodegraph.nodes.group_node import GroupNode
from nodegraph.nodes.port_node import PortInputNode, PortOutputNode
from nodegraph.widgets.node_graph import NodeGraphWidget, SubGraphWidget
...
class NodeGraph(QtCore.QObject):
    ...
    :parameters: :class:`nodegraph.NodeObject`
    :emits: created node
    """
    ...
    :parameters: list[:class:`nodegraph.NodeObject`],
                 list[:class:`nodegraph.NodeObject`]
    ...
    :parameters: :class:`nodegraph.Port`, :class:`nodegraph.Port`
    ...
    :parameters: :class:`nodegraph.BaseNode`, str, object
    ...
    def _build_context_menu(self):
        ...
        """
        from nodegraph.base.graph_actions import build_context_menu
    ...
    def model(self):
        ...
        Returns:
            nodegraph.base.model.NodeGraphModel: node graph model.
        """
        return self._model
    ...
    def viewer(self):
        ...
        Warnings:
            ...
            by ``nodegraph`` components to get the widget use
    ...
    def scene(self):
        ...
        Returns:
            nodegraph.widgets.scene.NodeScene: node scene.
        """
    ...
    def set_grid_mode(self, mode=VIEWER_GRID_LINES):
        ...
        Note:
            ...
            * :attr:`nodegraph.constants.VIEWER_GRID_NONE`
            * :attr:`nodegraph.constants.VIEWER_GRID_DOTS`
            * :attr:`nodegraph.constants.VIEWER_GRID_LINES`
    ...
    def add_properties_bin(self, prop_bin):
        ...
        Args:
            prop_bin (nodegraph.PropertiesBinWidget): properties widget.
        """
    ...
    def context_menu(self):
        ...
        Returns:
            nodegraph.NodeGraphMenu: context menu object.
        """
    ...
    def context_nodes_menu(self):
        ...
        Returns:
            nodegraph.NodesMenu: context menu object.
        """
    ...
    def get_context_menu(self, menu):
        ...
        Returns:
            nodegraph.NodeGraphMenu or nodegraph.NodesMenu: context menu object.
        """
    ...
    def set_pipe_style(self, style=PIPE_LAYOUT_CURVED):
        ...
        Note:
            ...
            * :attr:`nodegraph.constants.PIPE_LAYOUT_CURVED`
            * :attr:`nodegraph.constants.PIPE_LAYOUT_STRAIGHT`
            * :attr:`nodegraph.constants.PIPE_LAYOUT_ANGLE`
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[nodegraph.BaseNode]): a list of nodes.
        """
    ...
    def add_node(self, node, pos=None, selected=True, push_undo=True):
        ...
        Args:
            node (nodegraph.BaseNode): node object.
    ...
    def delete_nodes(self, nodes, push_undo=True):
        ...
        Args:
            nodes (list[nodegraph.BaseNode]): list of node instances.
            push_undo (bool): register the command to the undo stack. (default: True)
        """
        if not nodes:
            return
    ...
    def all_nodes(self):
        ...
        Returns:
            list[nodegraph.BaseNode]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            nodegraph.NodeObject: node object.
        """
    ...
    def get_nodes_by_type(self, node_type):
        ...
        (see: :attr:`nodegraph.NodeObject.type_`)

        Args:
            node_type (str): node type identifier.

        Returns:
            list[nodegraph.NodeObject]: list of nodes.
        """
    ...
    def _serialize(self, nodes):
        ...
        Args:
            nodes (list[nodegraph.Nodes]): list of node instances.
    ...
    def _deserialize(self, data, relative_pos=False, pos=None):
        ...
        Returns:
            list[nodegraph.Nodes]: list of node instances.
        """
    ...
    def duplicate_nodes(self, nodes):
        ...
        Args:
            nodes (list[nodegraph.BaseNode]): list of nodes.
        Returns:
            list[nodegraph.BaseNode]: list of duplicated node instances.
        """
        if not nodes:
            return
    ...
    def _update_node_rank(node, nodes_rank, down_stream=True):
        ...
        Args:
            node (nodegraph.BaseNode): node to start from.
    ...
    def _compute_node_rank(nodes, down_stream=True):
        ...
        Args:
            nodes (list[nodegraph.BaseNode]): nodes to start ranking from.
            down_stream (bool): true to compute down stream.

        Returns:
            dict: {nodegraph.BaseNode: node_rank, ...}
        """
        nodes_rank = {}
        for node in nodes:
            nodes_rank[node] = 0
    ...
    def auto_layout_nodes(self, nodes=None, down_stream=True, start_nodes=None):
        ...
        Args:
            nodes (list[nodegraph.BaseNode]): list of nodes to auto layout
                if nodes is None then all nodes is layed out.
            down_stream (bool): false to layout up stream.
            start_nodes (list[nodegraph.BaseNode]):
    ...
    def expand_group_node(self, node):
        ...
        Args:
            node (nodegraph.GroupNode): group node.
...
class SubGraph(NodeGraph):
    ...
    Inherited from: :class:`nodegraph.NodeGraph`
    ...
    def initialized_graphs(self):
        ...
        Returns:
            list[nodegraph.SubGraph]: list of sub graph objects.
        """
        if self._parent_graph.is_root:
    ...
    def parent_graph(self):
        ...
        Returns:
            nodegraph.NodeGraph or nodegraph.SubGraph: parent graph.
        """
    ...
    def node(self):
        ...
        Returns:
            nodegraph.GroupNode: group node.
        """
        return self._node
    ...
    def get_input_port_nodes(self):
        ...
        Returns:
            list[nodegraph.PortInputNode]: input nodes.
        """
    ...
    def get_output_port_nodes(self):
        ...
        Returns:
            list[nodegraph.PortOutputNode]: output nodes.
        """
    ...
    def get_node_by_port(self, port):
        ...
        Args:
            port (nodegraph.Port): parent node port object.
