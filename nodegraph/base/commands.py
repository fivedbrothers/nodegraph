...
class PropertyChangedCmd(QtGui.QUndoCommand):
    ...
    Args:
        node (nodegraph.NodeObject): node.
...
class NodeAddedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (nodegraph.NodeGraph): node graph.
        node (nodegraph.NodeObject): node.
...
class NodeRemovedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (nodegraph.NodeGraph): node graph.
        node (nodegraph.BaseNode or nodegraph.NodeObject): node.
    """
...
class NodeInputConnectedCmd(QtGui.QUndoCommand):
    ...
    Args:
        src_port (nodegraph.Port): source port.
        trg_port (nodegraph.Port): target port.
    """
