...
from nodegraph.errors import NodeMenuError
from nodegraph.widgets.actions import BaseMenu, GraphAction, NodeAction
...
class NodeGraphMenu(object):
    ...
    def get_menu(self, name):
        ...
        Returns:
            nodegraph.NodeGraphMenu: menu item.
        """
    ...
    def get_command(self, name):
        ...
        Returns:
            nodegraph.MenuCommand: context menu command.
        """
    ...
    def all_commands(self):
        ...
        Returns:
            list[nodegraph.MenuCommand]: list of commands.
        """
    ...
    def add_menu(self, name):
        ...
        Returns:
            nodegraph.NodeGraphMenu: the appended menu item.
        """
    ...
    def add_command(self, name, func=None, shortcut=None):
        ...
        Returns:
            nodegraph.NodeGraphCommand: the appended command.
        """
...
class NodesMenu(NodeGraphMenu):
    ...
    **Inherited from:** :class:`nodegraph.NodeGraphMenu`
