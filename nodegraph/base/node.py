...
from nodegraph.base.commands import PropertyChangedCmd
from nodegraph.base.model import NodeModel
from nodegraph.constants import (NODE_PROP,
...
class NodeObject(object):
    """
    The ``nodegraph.NodeObject`` class is the main base class that all
    nodes inherit from.

    **Inherited by:**
        :class:`nodegraph.BaseNode`,
        :class:`nodegraph.BackdropNode`
    ...
    Args:
        qgraphics_views (dict): Dictionary with the node layout type as the key
            ...
            .. code-block:: python
                ...
                # snippet taken from the nodegraph.BaseNode class.

                class BaseNode(NodeObject):

                    def __init__(self, qgraphics_views=None):
                        qgraphics_views = qgraphics_views or {
                            nodegraph.constants.NODE_LAYOUT_HORIZONTAL: NodeItem,
                            nodegraph.constants.NODE_LAYOUT_VERTICAL: NodeItemVertical
                        }
    ...
    def graph(self):
        ...
        Returns:
            nodegraph.NodeGraph: node graph.
        """
        return self._graph
    ...
    def view(self):
        ...
        Returns:
            nodegraph.qgraphics.node_abstract.AbstractNodeItem: node item.
        """
        return self._view
    ...
    def set_view(self, item):
        ...
        Args:
            item (nodegraph.qgraphics.node_abstract.AbstractNodeItem): node item.
        """
        if self._view:
            old_view = self._view
    ...
    def model(self):
        ...
        Returns:
            nodegraph.base.model.NodeModel: node model object.
        """
        return self._model
    ...
    def set_model(self, model):
        ...
        Args:
            model (nodegraph.base.model.NodeModel): node model object.
        """
        self._model = model
        self._model.type_ = self.type_
    ...
    def create_property(self, name, value, items=None, range=None,
        ...
        Hint:
            ...
            - :attr:`nodegraph.constants.NODE_PROP`
            - :attr:`nodegraph.constants.NODE_PROP_QLABEL`
            - :attr:`nodegraph.constants.NODE_PROP_QLINEEDIT`
            - :attr:`nodegraph.constants.NODE_PROP_QTEXTEDIT`
            - :attr:`nodegraph.constants.NODE_PROP_QCOMBO`
            - :attr:`nodegraph.constants.NODE_PROP_QCHECKBOX`
            - :attr:`nodegraph.constants.NODE_PROP_QSPINBOX`
            - :attr:`nodegraph.constants.NODE_PROP_COLORPICKER`
            - :attr:`nodegraph.constants.NODE_PROP_FILE`
            - :attr:`nodegraph.constants.NODE_PROP_VECTOR2`
            - :attr:`nodegraph.constants.NODE_PROP_VECTOR3`
            - :attr:`nodegraph.constants.NODE_PROP_VECTOR4`
            - :attr:`nodegraph.constants.NODE_PROP_FLOAT`
            - :attr:`nodegraph.constants.NODE_PROP_INT`
            - :attr:`nodegraph.constants.NODE_PROP_BUTTON`
