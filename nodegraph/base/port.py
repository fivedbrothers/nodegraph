...
from nodegraph.base.commands import (
    PortConnectedCmd,
    PortDisconnectedCmd,
    PortLockedCmd,
    PortUnlockedCmd,
...
from nodegraph.base.model import PortModel
...
class Port(object):
    ...
    Args:
        node (nodegraph.NodeObject): parent node.
    ...
    def view(self):
        ...
        Returns:
            nodegraph.qgraphics.port.PortItem: port item.
        """
        return self.__view
    ...
    def model(self):
        ...
        Returns:
            nodegraph.base.model.PortModel: port model.
        """
        return self.__model
    ...
    def type_(self):
        ...
        Port Types:
            - :attr:`nodegraph.constants.IN_PORT` for input port
            - :attr:`nodegraph.constants.OUT_PORT` for output port
    ...
    def node(self):
        ...
        Returns:
            nodegraph.BaseNode: parent node object.
        """
    ...
    def connected_ports(self):
        ...
        Returns:
            list[nodegraph.Port]: list of connected ports.
        """
        ports = []
        graph = self.node().graph
