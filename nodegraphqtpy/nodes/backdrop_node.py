...
from nodegraphqtpy.constants import (NODE_PROP_QTEXTEDIT,
...
class BackdropNode(NodeObject):
    """
    The ``nodegraphqtpy.BackdropNode`` class allows other node object to be
    ...
    **Inherited from:** :class:`nodegraphqtpy.NodeObject`
    ...
    def wrap_nodes(self, nodes):
        ...
        Args:
            nodes (list[nodegraphqtpy.NodeObject]): list of nodes.
        """
        if not nodes:
            return
    ...
    def nodes(self):
        ...
        Returns:
            list[nodegraphqtpy.BaseNode]: list of node under the backdrop.
        """
