...
from nodegraphqtpy.constants import (NODE_PROP_QLABEL,
                                   NODE_PROP_QLINEEDIT,
                                   NODE_PROP_QCOMBO,
                                   NODE_PROP_QCHECKBOX,
                                   IN_PORT, OUT_PORT,
...
from nodegraphqtpy.errors import (PortError,
...
class BaseNode(NodeObject):
    """
    The ``nodegraphqtpy.BaseNode`` class is the base class for nodes that allows
    port connections from one node to another.

    **Inherited from:** :class:`nodegraphqtpy.NodeObject`
    ...
    def add_custom_widget(self, widget, widget_type=NODE_PROP_QLABEL, tab=None):
        ...
        Args:
            ...
            widget_type: widget flag to display in the
                :class:`nodegraphqtpy.PropertiesBinWidget` (default: QLabel).
    ...
    def add_input(self, name='input', multi_input=False, display_name=True,
        ...
        Returns:
            nodegraphqtpy.Port: the created port object.
        """
    ...
    def input_ports(self):
        ...
        Returns:
            list[nodegraphqtpy.Port]: node input ports.
        """
        return self._inputs
    ...
    def output_ports(self):
        ...
        Returns:
            list[nodegraphqtpy.Port]: node output ports.
        """
    ...
    def input(self, index):
        ...
        Returns:
            nodegraphqtpy.Port: port object.
        """
    ...
    def set_input(self, index, port):
        ...
        Args:
            ...
            port (nodegraphqtpy.Port): port object.
        """
    ...
    def on_input_connected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (nodegraphqtpy.Port): source input port from this node.
            out_port (nodegraphqtpy.Port): output port that connected to this node.
        """
        return
    ...
    def on_input_disconnected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (nodegraphqtpy.Port): source input port from this node.
            out_port (nodegraphqtpy.Port): output port that was disconnected.
        """
        return
