...
from nodegraphqtpy.errors import PortRegistrationError
from nodegraphqtpy.nodes.base_node import BaseNode
from nodegraphqtpy.qgraphics.node_port_in import (PortInputNodeItem,
                                                PortInputNodeVerticalItem)
from nodegraphqtpy.qgraphics.node_port_out import (PortOutputNodeItem,
...
class PortInputNode(BaseNode):
    ...
    :class:`nodegraphqtpy.GroupNode` when expanded in a
    :class:`nodegraphqtpy.SubGraph`.
