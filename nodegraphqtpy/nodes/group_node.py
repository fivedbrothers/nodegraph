...
from nodegraphqtpy.constants import (NODE_LAYOUT_VERTICAL,
...
from nodegraphqtpy.qgraphics.node_group import (GroupNodeItem,
                                              GroupNodeVerticalItem)


class GroupNode(BaseNode):
    """
    The ``nodegraphqtpy.GroupNode`` class extends from the
    :class:``nodegraphqtpy.BaseNode`` class with the ability to nest other nodes
    inside of it.

    **Inherited from:** :class:`nodegraphqtpy.BaseNode`
    ...
    def get_sub_graph(self):
        ...
        Returns:
            nodegraphqtpy.SubGraph or None: sub graph controller.
        """
