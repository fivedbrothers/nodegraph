...
class PropertiesBinWidget(QtWidgets.QWidget):
    """
    The :class:`nodegraphqtpy.PropertiesBinWidget` is a list widget for displaying
    ...
    .. code-block:: python
        ...
        from nodegraphqtpy import NodeGraph, PropertiesBinWidget
    ...
    Args:
        ...
        node_graph (nodegraphqtpy.NodeGraph): node graph.
    """
    ...
    def add_node(self, node):
        ...
        Args:
            node (nodegraphqtpy.NodeObject): node object.
        """
    ...
    def remove_node(self, node):
        ...
        Args:
            node (str or nodegraphqtpy.BaseNode): node id or node object.
        """
    ...
    def prop_widget(self, node):
        ...
        Args:
            node (str or nodegraphqtpy.NodeObject): node id or node object.
...
if __name__ == '__main__':
    import sys
    from nodegraphqtpy import BaseNode, NodeGraph
