...
from nodegraphqtpy.constants import URN_SCHEME
...
class NodesPaletteWidget(QtWidgets.QWidget):
    ...
    .. code-block:: python
        ...
        from nodegraphqtpy import NodeGraph, NodesPaletteWidget
