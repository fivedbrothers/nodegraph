...
from nodegraphqtpy.constants import VIEWER_GRID_COLOR, Z_VAL_NODE_WIDGET
from nodegraphqtpy.errors import NodeWidgetError
...
class NodeBaseWidget(QtWidgets.QGraphicsProxyWidget):
    ...
    added in a :class:`nodegraphqtpy.BaseNode` object.

    Args:
        parent (nodegraphqtpy.BaseNode.view): parent node view.
    ...
    def node(self):
        ...
        Returns:
            nodegraphqtpy.BaseNode: parent node.
        """
        return self._node
...
class NodeComboBox(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraphqtpy.BaseNode.add_combo_menu`
    """
...
class NodeLineEdit(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraphqtpy.BaseNode.add_text_input`
    """
...
class NodeCheckBox(NodeBaseWidget):
    ...
    **Inherited from:** :class:`NodeBaseWidget`
    ...
    .. note::
        ...
        :meth:`nodegraphqtpy.BaseNode.add_checkbox`
    """
