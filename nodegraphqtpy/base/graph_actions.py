...
def build_context_menu(graph):
    ...
    Args:
        graph (nodegraphqtpy.NodeGraph): node graph controller.
    """
...
def _curved_pipe(graph):
    ...
    """
    from nodegraphqtpy.constants import PIPE_LAYOUT_CURVED
...
def _straight_pipe(graph):
    ...
    """
    from nodegraphqtpy.constants import PIPE_LAYOUT_STRAIGHT
...
def _angle_pipe(graph):
    ...
    """
    from nodegraphqtpy.constants import PIPE_LAYOUT_ANGLE
...
def _bg_grid_none(graph):
    ...
    """
    from nodegraphqtpy.constants import VIEWER_GRID_NONE
...
def _bg_grid_dots(graph):
    ...
    """
    from nodegraphqtpy.constants import VIEWER_GRID_DOTS
...
def _bg_grid_lines(graph):
    ...
    """
    from nodegraphqtpy.constants import VIEWER_GRID_LINES
