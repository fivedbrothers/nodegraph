...
class NodeGraphMenu(object):
    ...
    def get_menu(self, name):
        ...
        Returns:
            nodegraphqtpy.NodeGraphMenu: menu item.
        """
    ...
    def get_command(self, name):
        ...
        Returns:
            nodegraphqtpy.MenuCommand: context menu command.
        """
    ...
    def all_commands(self):
        ...
        Returns:
            list[nodegraphqtpy.MenuCommand]: list of commands.
        """
    ...
    def add_menu(self, name):
        ...
        Returns:
            nodegraphqtpy.NodeGraphMenu: the appended menu item.
        """
    ...
    def add_command(self, name, func=None, shortcut=None):
        ...
        Returns:
            nodegraphqtpy.NodeGraphCommand: the appended command.
        """
...
class NodesMenu(NodeGraphMenu):
    ...
    **Inherited from:** :class:`nodegraphqtpy.NodeGraphMenu`
