...
from nodegraphqtpy.base.commands import (NodeAddedCmd,
                                       ...
                                       NodeMovedCmd,
                                       PortConnectedCmd)
from nodegraphqtpy.base.factory import NodeFactory
from nodegraphqtpy.base.menu import NodeGraphMenu, NodesMenu
from nodegraphqtpy.base.model import NodeGraphModel
from nodegraphqtpy.base.node import NodeObject
from nodegraphqtpy.base.port import Port
...
from nodegraphqtpy.nodes.backdrop_node import BackdropNode
from nodegraphqtpy.nodes.base_node import BaseNode
from nodegraphqtpy.nodes.group_node import GroupNode
from nodegraphqtpy.nodes.port_node import PortInputNode, PortOutputNode
from nodegraphqtpy.widgets.node_graph import NodeGraphWidget, SubGraphWidget
from nodegraphqtpy.widgets.viewer import NodeViewer
from nodegraphqtpy.widgets.viewer_nav import NodeNavigationWidget
...
class NodeGraph(QtCore.QObject):
    ...
    :parameters: :class:`nodegraphqtpy.NodeObject`
    :emits: created node
    """
    ...
    :parameters: list[:class:`nodegraphqtpy.NodeObject`],
                 list[:class:`nodegraphqtpy.NodeObject`]
    ...
    :parameters: :class:`nodegraphqtpy.Port`, :class:`nodegraphqtpy.Port`
    ...
    :parameters: :class:`nodegraphqtpy.BaseNode`, str, object
    ...
    def _build_context_menu(self):
        ...
        """
        from nodegraphqtpy.base.graph_actions import build_context_menu
    ...
    def model(self):
        ...
        Returns:
            nodegraphqtpy.base.model.NodeGraphModel: node graph model.
        """
        return self._model
    ...
    def undo_view(self):
        ...
        Returns:
            PySide6.QtGui.QUndoView: node graph undo view.
        """
        if self._undo_view is None:
            self._undo_view = QtGui.QUndoView(self._undo_stack)
    ...
    def viewer(self):
        ...
        Warnings:
            ...
            by ``nodegraphqtpy`` components to get the widget use
        ...
        Returns:
            nodegraphqtpy.widgets.viewer.NodeViewer: viewer interface.
        """
        return self._viewer
    ...
    def scene(self):
        ...
        Returns:
            nodegraphqtpy.widgets.scene.NodeScene: node scene.
        """
    ...
    def set_grid_mode(self, mode=VIEWER_GRID_LINES):
        ...
        Note:
            ...
            * :attr:`nodegraphqtpy.constants.VIEWER_GRID_NONE`
            * :attr:`nodegraphqtpy.constants.VIEWER_GRID_DOTS`
            * :attr:`nodegraphqtpy.constants.VIEWER_GRID_LINES`
    ...
    def add_properties_bin(self, prop_bin):
        ...
        Args:
            prop_bin (nodegraphqtpy.PropertiesBinWidget): properties widget.
        """
    ...
    def context_menu(self):
        ...
        Returns:
            nodegraphqtpy.NodeGraphMenu: context menu object.
        """
    ...
    def context_nodes_menu(self):
        ...
        Returns:
            nodegraphqtpy.NodesMenu: context menu object.
        """
    ...
    def get_context_menu(self, menu):
        ...
        Returns:
            nodegraphqtpy.NodeGraphMenu or nodegraphqtpy.NodesMenu: context menu object.
        """
    ...
    def set_pipe_style(self, style=PIPE_LAYOUT_CURVED):
        ...
        Note:
            ...
            * :attr:`nodegraphqtpy.constants.PIPE_LAYOUT_CURVED`
            * :attr:`nodegraphqtpy.constants.PIPE_LAYOUT_STRAIGHT`
            * :attr:`nodegraphqtpy.constants.PIPE_LAYOUT_ANGLE`
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]): a list of nodes.
        """
    ...
    def add_node(self, node, pos=None, selected=True, push_undo=True):
        ...
        Args:
            node (nodegraphqtpy.BaseNode): node object.
    ...
    def delete_nodes(self, nodes, push_undo=True):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]): list of node instances.
            push_undo (bool): register the command to the undo stack. (default: True)
        """
        if not nodes:
            return
    ...
    def all_nodes(self):
        ...
        Returns:
            list[nodegraphqtpy.BaseNode]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            nodegraphqtpy.NodeObject: node object.
        """
    ...
    def get_nodes_by_type(self, node_type):
        ...
        (see: :attr:`nodegraphqtpy.NodeObject.type_`)

        Args:
            node_type (str): node type identifier.

        Returns:
            list[nodegraphqtpy.NodeObject]: list of nodes.
        """
    ...
    def _serialize(self, nodes):
        ...
        Args:
            nodes (list[nodegraphqtpy.Nodes]): list of node instances.
    ...
    def _deserialize(self, data, relative_pos=False, pos=None):
        ...
        Returns:
            list[nodegraphqtpy.Nodes]: list of node instances.
        """
    ...
    def copy_nodes(self, nodes=None):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]):
    ...
    def duplicate_nodes(self, nodes):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]): list of nodes.
        Returns:
            list[nodegraphqtpy.BaseNode]: list of duplicated node instances.
        """
        if not nodes:
            return
    ...
    def _update_node_rank(node, nodes_rank, down_stream=True):
        ...
        Args:
            node (nodegraphqtpy.BaseNode): node to start from.
    ...
    def _compute_node_rank(nodes, down_stream=True):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]): nodes to start ranking from.
            down_stream (bool): true to compute down stream.

        Returns:
            dict: {nodegraphqtpy.BaseNode: node_rank, ...}
        """
        nodes_rank = {}
        for node in nodes:
            nodes_rank[node] = 0
    ...
    def auto_layout_nodes(self, nodes=None, down_stream=True, start_nodes=None):
        ...
        Args:
            nodes (list[nodegraphqtpy.BaseNode]): list of nodes to auto layout
                if nodes is None then all nodes is layed out.
            down_stream (bool): false to layout up stream.
            start_nodes (list[nodegraphqtpy.BaseNode]):
    ...
    def expand_group_node(self, node):
        ...
        Args:
            node (nodegraphqtpy.GroupNode): group node.
...
class SubGraph(NodeGraph):
    ...
    Inherited from: :class:`nodegraphqtpy.NodeGraph`
    ...
    def initialized_graphs(self):
        ...
        Returns:
            list[nodegraphqtpy.SubGraph]: list of sub graph objects.
        """
        if self._parent_graph.is_root:
    ...
    def parent_graph(self):
        ...
        Returns:
            nodegraphqtpy.NodeGraph or nodegraphqtpy.SubGraph: parent graph.
        """
    ...
    def node(self):
        ...
        Returns:
            nodegraphqtpy.GroupNode: group node.
        """
        return self._node
    ...
    def get_input_port_nodes(self):
        ...
        Returns:
            list[nodegraphqtpy.PortInputNode]: input nodes.
        """
    ...
    def get_output_port_nodes(self):
        ...
        Returns:
            list[nodegraphqtpy.PortOutputNode]: output nodes.
        """
    ...
    def get_node_by_port(self, port):
        ...
        Args:
            port (nodegraphqtpy.Port): parent node port object.
