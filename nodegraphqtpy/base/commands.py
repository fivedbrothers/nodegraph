...
class PropertyChangedCmd(QtGui.QUndoCommand):
    ...
    Args:
        node (nodegraphqtpy.NodeObject): node.
...
class NodeAddedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (nodegraphqtpy.NodeGraph): node graph.
        node (nodegraphqtpy.NodeObject): node.
...
class NodeRemovedCmd(QtGui.QUndoCommand):
    ...
    Args:
        graph (nodegraphqtpy.NodeGraph): node graph.
        node (nodegraphqtpy.BaseNode or nodegraphqtpy.NodeObject): node.
    """
...
class NodeInputConnectedCmd(QtGui.QUndoCommand):
    ...
    Args:
        src_port (nodegraphqtpy.Port): source port.
        trg_port (nodegraphqtpy.Port): target port.
    """
...
class PortLockedCmd(QtGui.QUndoCommand):
    ...
    Args:
        port (nodegraphqtpy.Port): node port.
    """
