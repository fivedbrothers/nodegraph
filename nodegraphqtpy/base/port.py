...
from nodegraphqtpy.base.commands import (
    PortConnectedCmd,
    PortDisconnectedCmd,
    PortLockedCmd,
    PortUnlockedCmd,
...
from nodegraphqtpy.base.model import PortModel
...
class Port(object):
    ...
    Args:
        node (nodegraphqtpy.NodeObject): parent node.
    ...
    def view(self):
        ...
        Returns:
            nodegraphqtpy.qgraphics.port.PortItem: port item.
        """
        return self.__view
    ...
    def model(self):
        ...
        Returns:
            nodegraphqtpy.base.model.PortModel: port model.
        """
        return self.__model
    ...
    def type_(self):
        ...
        Port Types:
            - :attr:`nodegraphqtpy.constants.IN_PORT` for input port
            - :attr:`nodegraphqtpy.constants.OUT_PORT` for output port
    ...
    def node(self):
        ...
        Returns:
            nodegraphqtpy.BaseNode: parent node object.
        """
    ...
    def connected_ports(self):
        ...
        Returns:
            list[nodegraphqtpy.Port]: list of connected ports.
        """
        ports = []
        graph = self.node().graph
