...
from nodegraphqtpy.base.commands import PropertyChangedCmd
from nodegraphqtpy.base.model import NodeModel
from nodegraphqtpy.constants import (NODE_PROP,
...
class NodeObject(object):
    """
    The ``nodegraphqtpy.NodeObject`` class is the main base class that all
    nodes inherit from.

    **Inherited by:**
        :class:`nodegraphqtpy.BaseNode`,
        :class:`nodegraphqtpy.BackdropNode`
    ...
    Args:
        qgraphics_views (dict): Dictionary with the node layout type as the key
            ...
            .. code-block:: python
                ...
                # snippet taken from the nodegraphqtpy.BaseNode class.

                class BaseNode(NodeObject):

                    def __init__(self, qgraphics_views=None):
                        qgraphics_views = qgraphics_views or {
                            nodegraphqtpy.constants.NODE_LAYOUT_HORIZONTAL: NodeItem,
                            nodegraphqtpy.constants.NODE_LAYOUT_VERTICAL: NodeItemVertical
                        }
    ...
    def graph(self):
        ...
        Returns:
            nodegraphqtpy.NodeGraph: node graph.
        """
        return self._graph
    ...
    def view(self):
        ...
        Returns:
            nodegraphqtpy.qgraphics.node_abstract.AbstractNodeItem: node item.
        """
        return self._view
    ...
    def set_view(self, item):
        ...
        Args:
            item (nodegraphqtpy.qgraphics.node_abstract.AbstractNodeItem): node item.
        """
        if self._view:
            old_view = self._view
    ...
    def model(self):
        ...
        Returns:
            nodegraphqtpy.base.model.NodeModel: node model object.
        """
        return self._model
    ...
    def set_model(self, model):
        ...
        Args:
            model (nodegraphqtpy.base.model.NodeModel): node model object.
        """
        self._model = model
        self._model.type_ = self.type_
    ...
    def create_property(self, name, value, items=None, range=None,
        ...
        See Also:
            ...
            :class:`nodegraphqtpy.PropertiesBinWidget`

        Hint:
            Here are some constants variables used to define the node
            widget type in the ``PropertiesBinWidget``.

            - :attr:`nodegraphqtpy.constants.NODE_PROP`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QLABEL`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QLINEEDIT`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QTEXTEDIT`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QCOMBO`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QCHECKBOX`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_QSPINBOX`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_COLORPICKER`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_FILE`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_VECTOR2`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_VECTOR3`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_VECTOR4`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_FLOAT`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_INT`
            - :attr:`nodegraphqtpy.constants.NODE_PROP_BUTTON`
