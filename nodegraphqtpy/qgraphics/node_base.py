...
from nodegraphqtpy.qgraphics.node_overlay_disabled import XDisabledItem
from nodegraphqtpy.qgraphics.node_text_item import NodeTextItem
from nodegraphqtpy.qgraphics.port import PortItem, CustomPortItem
...
class NodeItem(AbstractNodeItem):
    ...
    def post_init(self, viewer=None, pos=None):
        ...
        Args:
            viewer (nodegraphqtpy.widgets.viewer.NodeViewer): not used
