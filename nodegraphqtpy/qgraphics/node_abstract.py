...
from nodegraphqtpy.constants import (Z_VAL_NODE,
                                   NODE_WIDTH,
                                   NODE_HEIGHT,
                                   ITEM_CACHE_MODE)
...
class AbstractNodeItem(QtWidgets.QGraphicsItem):
    ...
    def pre_init(self, viewer, pos=None):
        ...
        Args:
            viewer (nodegraphqtpy.widgets.viewer.NodeViewer): main viewer.
    ...
    def viewer(self):
        ...
        Returns:
            nodegraphqtpy.widgets.viewer.NodeViewer: viewer object.
        """
        if self.scene():
